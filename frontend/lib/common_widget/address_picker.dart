            ...
            children: <Widget>[
              SizedBox(
                  ...
                  child: DropdownButton<Province>(
                      ...
                      hint: Text(
                          widget.initData?.province ?? 'Chọn Tỉnh/Thành phố',
              ...
              Padding(
                  ...
                  child: SizedBox(
                      ...
                      child: DropdownButton<District>(
                          hint: Text(widget.initData?.district ?? 'Chọn Quân/Huyện',
                              style: const TextStyle()
                                  .merge(widget.placeHolderTextStyle)),
              ...
              SizedBox(
                  ...
                  child: DropdownButton<Wards>(
                      hint: Text(widget.initData?.ward ?? 'Chọn Phường/Xã',
                          style: const TextStyle()
                              .merge(widget.placeHolderTextStyle)),
                      value: _wardsSelected,
                      isExpanded: true,
                      underline: widget.underline,
                      items: (_districtSelected ?? District(wards: []))
                          .wards
                          .map((w) {
