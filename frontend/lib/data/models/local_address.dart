...
class LocalAddress {
  ...
  LocalAddress copyWith({String? address}) => LocalAddress(province: province, district: district, ward: ward, address: address);

  Map<String, dynamic> toJson() => _$LocalAddressToJson(this);

  @override
  String toString() {
    return '${address == null ? '' : '$address, '}${ward == null ? '' : '$ward, '}${district == null ? '' : '$district, '}${province ?? '' }';
  }
}
...
class Province {
  ...
  Province(
      ...
      this.code,
      this.type,
      List<District>? districts}): districts = districts ?? <District>[];
...
class District {
  ...
  District(
      ...
      this.code,
      this.type,
      List<Wards>? wards}) : wards = wards ?? <Wards>[];
